...
fun TopNavBar(
    ...
    val icon = when(screen) {
        ...
        Screens.AddNoteScreen -> Icons.Outlined.Clear
        Screens.NoteDisplayScreen -> null
        Screens.ImageNoteScreen -> TODO()
        Screens.VideoNoteScreen -> TODO()
        Screens.DisplayVideo -> TODO()
    }
    ...
    Box(modifier = Modifier.background(secondaryColor)) {
        Row (
            ...
            CustomText(text = title, textColor = Color.Black, fontFamily = ribeyeFamily, fontSize = 34)
            if (icon != null)
